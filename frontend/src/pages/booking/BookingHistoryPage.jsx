    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
                {loading ? (
                    [1, 2, 3].map((item) => (
                        <div key={item} className="bg-white rounded-2xl p-6 border border-gray-100 animate-pulse">
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                <div className="flex-1">
                                    <div className="flex items-start justify-between lg:justify-start lg:gap-4 mb-2">
                                        ...
                                        <span className="px-3 py-1 rounded-full text-[11px] font-bold border uppercase flex items-center gap-1.5 bg-green-100 text-green-700 border-green-200">
